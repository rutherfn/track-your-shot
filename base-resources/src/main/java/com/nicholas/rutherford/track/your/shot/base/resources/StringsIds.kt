...
object StringsIds {
    ...
    val cannotEditVoiceCommand = R.string.cannot_edit_voice_command
    val cannotSaveVoiceCommand = R.string.cannot_save_voice_command
    ...
    val couldNotDeleteCommand = R.string.could_not_delete_command
    val couldNotDeleteCommandDescription = R.string.could_not_delete_command_description
    ...
    val deleteCommand = R.string.delete_command
    val deleteCommandSuccessfully = R.string.delete_command_successfully
    val deleteCommandSuccessfullyDescription = R.string.delete_command_successfully_description
    ...
    val deletingCommand = R.string.deleting_command
    ...
    val editPhraseXToUseThisCommand = R.string.edit_phrase_x_to_use_for_this_command
    val editPlayer = R.string.edit_player
    val editVoiceCommand = R.string.edit_voice_command
    val editX = R.string.edit_x
    val editXCommand = R.string.edit_x_command
    val editedNewMakeCommandDescription = R.string.edited_new_make_voice_command_description
    val editedNewMissCommandDescription = R.string.edited_new_miss_voice_command_description
    val editedNewStartCommandDescription = R.string.edited_new_start_voice_command_description
    val editedNewStopCommandDescription = R.string.edited_new_stop_voice_command_description
    ...
    val emailIsRequiredPleaseEnterAEmailToCreateAAccount =
        R.string.email_is_required_please_enter_a_email_to_create_a_account
    val emailIsRequiredPleaseEnterAEmailToLoginToExistingAccount =
        R.string.email_is_required_please_enter_a_email_to_login_to_existing_account
    ...
    val errorVoiceCommandEditFailure = R.string.error_voice_command_edit_failed
    ...
    val havingTroubleLoggingIntoYourAccountPleaseTryAgainAndEnsureCredentialsExistAndAreValid =
        R.string.having_trouble_logging_into_your_account_please_try_again_and_or_ensure_credentials_exist_and_are_valid
    ...
    val newCommandSavedSuccessfully = R.string.new_command_saved_successfully
    val next = R.string.next
    val no = R.string.no
    val noChangesMade = R.string.no_changes_made
    val noCommandEntered = R.string.no_command_entered
    val noCommandEnteredDescription = R.string.no_command_entered_description
    ...
    val passwordIsRequiredPleaseEnterAPasswordToCreateAAccount =
    ...
    val searchShots = R.string.search_shots
    ...
    val savedNewMakeCommandDescription = R.string.saved_new_make_voice_command_description
    val savedNewMissCommandDescription = R.string.saved_new_miss_voice_command_description
    val savedNewStartCommandDescription = R.string.saved_new_start_voice_command_description
    val savedNewStopCommandDescription = R.string.saved_new_stop_voice_command_description
