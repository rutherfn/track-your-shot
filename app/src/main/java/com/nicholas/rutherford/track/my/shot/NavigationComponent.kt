...
import com.nicholas.rutherford.track.my.shot.feature.players.list.PlayersListScreen
import com.nicholas.rutherford.track.my.shot.feature.players.list.PlayersListScreenParams
...
fun NavigationComponent(
    ...
    NavHost(
        ...
        composable(route = NavigationDestinations.PLAYERS_LIST_SCREEN) {
            PlayersListScreen(
                playerListScreenParams = PlayersListScreenParams(state = playersListViewModel.playerListStateFlow.collectAsState().value)
            )
        }
