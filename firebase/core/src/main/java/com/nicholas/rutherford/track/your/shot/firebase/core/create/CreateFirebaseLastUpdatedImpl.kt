...
class CreateFirebaseLastUpdatedImpl(private val firebaseDatabase: FirebaseDatabase) : CreateFirebaseLastUpdated {
    ...
    override fun attemptToCreateLastUpdatedFlow(date: Date): Flow<Boolean> {
        return callbackFlow {
            ...
            firebaseDatabase.getReference(Constants.CONTENT_LAST_UPDATED_PATH).setValue(values)
