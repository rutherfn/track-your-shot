...
class DeleteFirebaseUserInfoImplTest {
    ...
    private val savedVoiceCommandKey = "-voiceCommand123"
    ...
    inner class DeleteUser {
        ...
        fun `when add on failure listener is executed should set flow to false`() = runTest {
            ...
            val value = deleteFirebaseUserInfoImpl.deleteUser(uid = uid).first()
    ...
    @Nested
    inner class DeleteSavedVoiceCommand {
        ...
        fun `when add on complete listener is executed and returns isSuccessful returns true should set flow to true`() = runTest {
            ...
            val value = deleteFirebaseUserInfoImpl.deleteSavedVoiceCommand(savedVoiceCommandKey = savedVoiceCommandKey).first()
