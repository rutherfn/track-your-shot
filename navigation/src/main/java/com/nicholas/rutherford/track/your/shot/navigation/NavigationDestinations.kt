...
object NavigationDestinations {
    ...
    const val LOG_SHOT_WITH_PARAMS = "logShotScreen/{isExistingPlayer}/{playerId}/{shotId}/{currentPlayerShotsSize}"
    const val LOG_SHOT_SCREEN = "logShotScreen"
    const val SELECT_SHOT_SCREEN = "selectShotScreen"
    const val SELECT_SHOT_SCREEN_WITH_PARAMS = "selectShotScreen/{isExistingPlayer}/{playerId}/{currentPlayerShotsSize}"
