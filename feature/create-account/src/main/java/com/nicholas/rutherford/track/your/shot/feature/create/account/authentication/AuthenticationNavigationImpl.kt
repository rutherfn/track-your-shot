...
class AuthenticationNavigationImpl(private val navigator: Navigator) : AuthenticationNavigation {
    ...
    override fun navigateToTermsAndConditions() = navigator.navigate(navigationAction = NavigationActions.AuthenticationScreen.termsConditions(shouldAcceptTerms = true))
